...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/resources/master/_listings/aws-ec2-systems-manager/apis.md
...
- name: AWS EC2 Systems Manager API - Add Tags To Resource
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/resources/master/_listings/aws-ec2-systems-manager/actionaddtagstoresource-get-openapi.md
- name: AWS EC2 Systems Manager API - Remove Tags From Resource
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/resources/master/_listings/aws-ec2-systems-manager/actionremovetagsfromresource-get-openapi.md
- name: AWS EC2 Systems Manager API - Remove Tags From Resource
  x-api-slug: actionremovetagsfromresource-get
  description: Removes all tags from the specified resource.
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/Compute_AmazonEC2.png
...
- name: AWS EC2 Systems Manager API - List Tags For Resource
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/resources/master/_listings/aws-ec2-systems-manager/actionlisttagsforresource-get-openapi.md
- name: AWS EC2 Systems Manager API - Remove Tags From Resource
  x-api-slug: actionremovetagsfromresource-get
  description: Removes all tags from the specified resource.
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/Compute_AmazonEC2.png
