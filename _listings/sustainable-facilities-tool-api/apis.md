...
- name: Sustainable Facilities Tool API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/resources/master/_listings/sustainable-facilities-tool-api/building-systems-parameter-resources-get.md
- name: Sustainable Facilities Tool API Returns Building System Resources
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/resources/master/_listings/sustainable-facilities-tool-api/building-systems-parameter-resources-get-postman.md
x-common:
- type: x-developer
