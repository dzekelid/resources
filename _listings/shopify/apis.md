...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/resources/master/_listings/shopify/apis.md
...
- name: Shopify API - Get a single product metafield using the metafield's nested
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/resources/master/_listings/shopify/adminproducts7990943555metafields33058305934-json-get-openapi.md
- name: Shopify API - Get a single product metafield using the metafield's nested
    resource path
  x-api-slug: adminproducts7990943555metafields33058305934-json-get
  description: Get a single product metafield using the metafield's nested resource
