...
- name: Data.gov API Delete Datasets Dataset Resources R
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/resources/master/_listings/datagov/datasets-dataset-resources-rid-delete.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/resources/master/_listings/datagov/datasets-dataset-resources-rid-delete-postman.md
x-common:
- type: x-blog
