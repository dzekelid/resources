...
- name: Data.gov API Add Datasets Dataset Resources R Upload
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/resources/master/_listings/datagov/datasets-dataset-resources-rid-upload-post.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/resources/master/_listings/datagov/datasets-dataset-resources-rid-upload-post-postman.md
x-common:
- type: x-blog
